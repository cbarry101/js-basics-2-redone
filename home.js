...
const greetUser =  username => {    // we dont need paranthesis () around username because theres just 1 parameter but you still could put them
...
const canWeDeliver = zipCode => {
    if (deliveryAreaZipCodes.includes(zipCode)){  //there is both a string method and an array method for .includes
...
//console.log(canWeDeliver(852067))
